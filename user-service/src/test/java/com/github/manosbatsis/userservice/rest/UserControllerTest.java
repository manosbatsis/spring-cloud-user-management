package com.github.manosbatsis.userservice.rest;
...
import com.github.manosbatsis.userservice.rest.UserController;
...
import com.github.manosbatsis.userservice.service.UserService;
import com.github.manosbatsis.userservice.mapper.UserMapperImpl;
...
class UserControllerTest {
    ...
    private CreateUserRequest getDefaultCreateUserRequest() {
        return new CreateUserRequest("email@test", "fullName", "address", true);
    }
    ...
    private static final String JSON_$_ADDRESS = "$.address";
