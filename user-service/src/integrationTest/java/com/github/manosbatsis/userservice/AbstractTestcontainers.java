...
public abstract class AbstractTestcontainers {
    ...
    private static GenericContainer greenMailContainer = new GenericContainer<>(DockerImageName.parse("greenmail/standalone:latest"));
    ...
    private static void dynamicProperties(DynamicPropertyRegistry registry) {
        ...
        eventServiceContainer.withNetwork(network)
            ...
            .dependsOn(schemaRegistryContainer, kafkaContainer, greenMailContainer)
            .waitingFor(Wait.forHttp("/actuator/health")
